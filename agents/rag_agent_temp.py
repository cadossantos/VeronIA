...
class RagQueryEngine:
    def __init__(self, llm: BaseChatModel, vector_store_root: str = "db/vector_store", collection_names: list[str] | None = None, embedding_model: str = "text-embedding-3-small", k: int = 10):
        self.llm = llm
        ...
        for col_name in self.collection_names:
            ...
            try:
                ...
                retrievers.append(vectordb.as_retriever(search_kwargs={"k": self.k}))
